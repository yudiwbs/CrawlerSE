...
public class ProsesJSON {
    ...
    public void proses(String jsonStr) {
         ...
         JsonObject objRes = obj.getJsonObject("responseData");

         JsonArray results = objRes.getJsonArray("results");
         for (JsonObject result : results.getValuesAs(JsonObject.class)) {
             System.out.print(result.getJsonObject("GsearchResultClass").getString("url"));
             //System.out.print(": ");
